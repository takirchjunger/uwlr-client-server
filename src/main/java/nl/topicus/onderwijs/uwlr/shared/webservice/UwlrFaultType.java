...
public enum UwlrFaultType {
  ...
  SRV_TIJDELIJK_NIET_BESCHIKBAAR(
      "Server.TijdelijkNietBeschikbaar", "Server is tijdelijk niet beschikbaar"),

  /** Clientfouten: */
  CLT_ONGELDIG_BERICHT("Client.OngeldigBericht", "Inhoud van het bericht is ongeldig"),
  CLT_ONGELDIGE_KLANTIDENTIFICATIE(
      "Client.OngeldigeKlantIdentificatie", "Klantidentificatie onjuist"),
